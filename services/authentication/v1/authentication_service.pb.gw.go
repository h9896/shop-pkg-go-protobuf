...
func request_AuthenticationService_CreateUserSession_0(ctx context.Context, marshaler runtime.Marshaler, client AuthenticationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateUserSessionRequest
	...
	msg, err := client.CreateUserSession(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AuthenticationService_CreateUserSession_0(ctx context.Context, marshaler runtime.Marshaler, server AuthenticationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateUserSessionRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreateUserSession(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAuthenticationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthenticationServiceServer) error {
	...
	mux.Handle("POST", pattern_AuthenticationService_CreateUserSession_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/services.authentication.v1.AuthenticationService/CreateUserSession", runtime.WithHTTPPathPattern("/api/v1/userSession"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AuthenticationService_CreateUserSession_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_AuthenticationService_CreateUserSession_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAuthenticationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthenticationServiceClient) error {
	...
	mux.Handle("POST", pattern_AuthenticationService_CreateUserSession_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/services.authentication.v1.AuthenticationService/CreateUserSession", runtime.WithHTTPPathPattern("/api/v1/userSession"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AuthenticationService_CreateUserSession_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_AuthenticationService_CreateUserSession_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "userSession"}, ""))
)

var (
	forward_AuthenticationService_CreateUserSession_0 = runtime.ForwardResponseMessage
)
